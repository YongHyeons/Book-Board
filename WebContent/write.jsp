	...
	<nav class="navbar navbar-default" id = "hh">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav">
				...
				<li class = "active"><a href="bbs.jsp" style="color:black;">게시판</a></li>
			</ul>
			<%
				if(userID == null){
			%>
		...
		<div class ="row">
			<form method="post" action="writeAction.jsp">
				<table class="table table-striped" style = "text-align: center; border: 1px solid #dddddd">
					...
					<tbody>
						<tr>
							<td><input type="text" class="form-control" placeholder="글 제목" name="bbsTitle" mexlength="50"></td>
						</tr>
						<tr>
							<td><textarea type="text" class="form-control" placeholder="글 내용" name="bbsContent" mexlength="2048" style="height: 350px;"></textarea></td>
						</tr>
					</tbody>
				</table>
